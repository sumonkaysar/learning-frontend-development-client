...
const CardCourse = ({ course }) => {
  const { id, name, details, images, price, ratings } = course;

  return (
    <div className="card bg-base-100 shadow-xl">
      <figure className="h-40 overflow-hidden"><img className="object-cover w-full h-full" src={images[0]} alt="course" /></figure>
